...
class Adults : public Audience
{
	public:
		...
		//___________________________________
		Adults(string _name, int _age, int _seatNo) : Audience(_name, _age, _seatNo){}
...
class Kids : public Audience
{
	...
	public:
		...
		//___________________________________
		Kids(string _name, int _age, int _seatNo, string _pName) : Audience(_name, _age, _seatNo){
			parentName = _pName;
		}
		...
		void displayDetails(){
			Audience::displayDetails();
			cout << setw(25) << parentName << setw(9) << seatNo;
		}
};
		...
		void displayInfoAudience()
		{
			...
			else
			{
				...
				for(int i = 0; i < numAudience; i++){
					...
					cout << fixed << setprecision(2) << price *(1 - audienceList[i]->calcDisc()) << endl;
					totalPrice += price *(1 - audienceList[i]->calcDisc());
				}
			...
			case 2:
				...
				do
				{
					...
					else
					{
						cout << "Parent Name: ";
						getline(cin, pName);
						audiencePtr = new Kids(name, age, seatNo, pName);
					}
